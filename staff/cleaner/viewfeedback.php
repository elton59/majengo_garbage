        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <center><button onclick="window.location.replace('department.php')" class="btn btn-info" >Compose A new message</button></center>
                                    ...
                                    <th>Status</th>
                                        ...
                                        while($row=$result->fetch_assoc())
                                        {
                                           ...
                                           <td>".$row['email']."</td>
                                            <td>".$row['reply']."</td>
                                           <td>".$row['status']."</td>
                                           <td> <a href='reply.php?editfeedback=$row[id] 'class='btn btn-danger'>reply<a>
                                            </tbody>
                                            ";
                                        }
                                        ?>
