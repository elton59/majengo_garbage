        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- DataTales Example -->
                    <?php 
$result=$mysqli->query("select * from services where service_name='cleaning_service'")or die($mysqli->error);
...
?> 
                    <div class="card shadow mb-4">
                        ...
                        <p><u>Charges</u></p>
                            <hr/>
                            <p>Post construction:@ ksh 4000</p>
                            <p>event cleaning:@ ksh6000</p>
                            <p>Office cleanig: @ ksh 6000</p>
                            <p>carpet cleaning:@ ksh 2000</p>
                            <p>mattress cleaning:@ ksh 2000</p>
                            <p>House cleaning:@ ksh 2000</p>
                            ...
                            <div class="table-responsive">
                                <form method="POST" action="../process.php">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" value="<?php echo $expiry_date?>" readonly 
                                        />
                                    </div>
...
<div class="form-group">
    ...
    <option value="office_cleaning">Office Cleaning</option>
        ...
        <option value="house_cleaning_service">House Cleaning Service</option>
        <option value="post_construction_cleaning">Post Construction Cleaning</option>
        <option value="event_cleaning_service">Event Cleaning Service</option>
...
<div class="form-group">
<input class="form-control"   name="pickup_location"
/>
</div>
