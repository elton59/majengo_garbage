                        ...
                        <div class="card">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="appointment">
                                    ...
                                    <?php
                                      $get_user_id = $mysqli->query("SELECT * FROM garbage_collectors where email='$user'");
                            ...
                            if (isset($_GET['rq_id'])) {
                                ...
                                $row = $get_user_id->fetch_assoc();
                                $fname = $row['firstname'];
                                $result2=$mysqli->query("INSERT INTO notification(message) values('$fname (garbage collector)has completed his assigned task')")or die($mysqli->error);
