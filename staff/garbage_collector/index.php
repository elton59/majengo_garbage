...
<head>
    ...
    <title>Garbage Collector Login</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4"> Garbage Collector Login  </h1>
                                    </div>
                                    <form class="user" method="post" action="../process.php">
                                        ...
                                        <input type="submit" name="garbage_collector_login" class="btn btn-primary btn-user btn-block" value="login">
