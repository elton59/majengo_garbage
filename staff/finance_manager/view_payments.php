                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card">
                            ...
                            <table class="table table-bordered" id="appointment">
                                    ...
                                    <th>Status</th>
                                        ...
                                        while($row=$result->fetch_assoc())
                                        {
                                           ...
                                           <td> <a href='view_payments.php?ap_payment=$row[payment_id]' class='btn btn-success'>approve<a>
                                           <a href='view_payments.php?rj_payment=$row[payment_id]' class='btn btn-danger'>Reject<a></td>    
                                            </tbody>
                                            ";
                                        }
                                        ?>
                            ...
                            <?php
                            $get_user_id=$mysqli->query("SELECT * FROM finance_manager where email='$user'");
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Processed Payments</h6>
    </div>
    <div class="card">
        <div class="table-responsive"  >
        <table class="table table-bordered" id="appointment">
        ...
        <th>FirstName</th>
             ...
             <a href="payments_report.php"  button  class="btn btn-danger" >export to pdf</a>   
            </td>
        </div>
