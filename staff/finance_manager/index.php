                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4"> Finance Manager  Login  </h1>
                                    </div>
                                    <form class="user" method="post" action="../process.php">
                                        ...
                                        <input type="submit" name="finance_manager_login" class="btn btn-primary btn-user btn-block" value="login">
