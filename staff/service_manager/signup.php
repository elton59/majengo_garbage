                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                       <?php
if(isset($_POST['register_service_manager']))
{
   ...
   $result=$mysqli->query("INSERT INTO service_manager(firstname,lastname,username,email,adress,gender,password) values('$fname','$lname','$uname','$ademail','$padress','$gender','$password')")or die($mysqli->error);
		  ...
		  if($result==1)
	{
        ...
        location.replace('index.php');
            ...
            echo "
            <script>alert('Operaton failed, Please contact your admin');
            location.replace('index.php');
             </script>
                   ...
                   ";
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="submit" name="register_service_manager" class="btn btn-success btn-user btn-block" value="Request for Account">
